...
class GameBoardOutException(GameBoardException):
    def __str__(self):
        return "The shot is out of the field, hawkeye"


class GameBoardUsedException(GameBoardException):
    def __str__(self):
        ...
        for l in self.lens:
            while True:
                ...
                try:
                    board.add_ship(ship)
                    break
                except GameBoardWrongShipException:
                    pass
        board.begin()
        return board
